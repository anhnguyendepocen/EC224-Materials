...
\item Chapter 25: The basic tools of finance
\item Seminar preparation: Answer the question on student central
\end{itemize}
\end{frame}
...
\item With international financial markets this is a golbal market and one international interest rate
\end{itemize}
\end{frame}
...
\item If households fear for their jobs and their future, they continue to save even if interest rates are low
\end{itemize}
\pause
